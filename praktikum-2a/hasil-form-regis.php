...
<body>
  <div class="mx-auto mt-5 border border-2 border-dark p-3 bg-info text-black rounded" style="width: 45%;">
    <h3 class="text-center">Hasil Registrasi IT Club Data Science</h3>
    <table class="table border border-2 border-info mt-3 text-black w-75 mx-auto">
      <thead>
        <tr>
          <td>NIM</td>
          <td>:</td>
    ...
    <div class="text-center my-3">
      <a href="form-registrasi.php" class="btn btn-success">Kembali</a>
    </div>
  </div>
